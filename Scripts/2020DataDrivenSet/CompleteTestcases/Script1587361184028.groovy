...
//CustomKeywords.'standardFunc.AllstandardFunc.ClickonItemWin'()
*/
...
//config tabular
//CustomKeywords.'tabularFunc.AlltabularFunc.configTabularR15'(rowFields, colFields, dataFields, nSep, to,msrNameT,aggrType,rowSubTotal,rFieldnm,,cFieldnm,preview,ImageTabularEnable,colSubTotal,itemCount,tableName)
//CustomKeywords.'tabularFunc.AlltabularFunc.configTabular'(rowFields, colFields, dataFields, nSep, to,msrNameT,aggrType,rowSubTotal,rFieldnm,preview,ImageTabularEnable,colSubTotal,grandTotal,itemCount,tableName)
CustomKeywords.'tabularFunc.AlltabularFunc.configTabularR15'(rowFields, colFields, dataFields, nSep, vSep, to, msrNameT, aggrType, rowSubTotal, rFieldnm, cFieldnm, preview, ImageTabularEnable, colSubTotal, itemCount, tableName)
WebUI.delay(10)
...
//chk sort order
CustomKeywords.'com.BB.genralFunctions.tdoSortR15'(tsortAttrName,tattrStatus,nSep,vSep)
WebUI.delay(10)


//chk sort order for row fields
//chk sort order
CustomKeywords.'com.BB.genralFunctions.trowdoSortR15'(tsortRAttrName,tattrRStatus,nSep,vSep)
...
//Export Tabularr
CustomKeywords.'com.BB.genralFunctions.exportAllTabularR15'(exportFileName)
