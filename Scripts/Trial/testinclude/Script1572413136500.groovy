...
WebUI.delay(5)
//Click on exportfile name input box
//CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/exportfilename'),10)
//WebUI.delay(5)
//WebUI.scrollToElement(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/exportfilename'),10)
//WebUI.focus(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/exportfilename'))
//WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/exportfilename'),'testinclude')
...
//CustomKeywords.'com.test.demo.MySelectionCustomFunctions.ScrollTo'(findTestObject('Object Repository/Final Objects/Layout/ExportData/attachment/Includeattachments'),10)
