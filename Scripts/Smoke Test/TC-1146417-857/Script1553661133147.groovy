...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '316.34')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '1521.56')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Show Data/SD-brand'), 
    10)
...
WebUI.setText(findTestObject('Final Objects/Layout/Main Buttons/exportfilename'), '1146417-857')
