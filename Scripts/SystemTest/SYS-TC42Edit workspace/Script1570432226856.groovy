...
WebUI.delay(5)
//Edit workspace
WebUI.click(findTestObject('Object Repository/Final Objects/LoadWSfromWSmodule/EditWS'))
WebUI.delay(10)
//Close Edit workspace window
WebUI.click(findTestObject('Object Repository/Final Objects/LoadWSfromWSmodule/closedEditWSWindw'))
//WebUI.click(findTestObject('Object Repository/Final Objects/LoadWSfromWSmodule/EditWSCancelBtn'))
WebUI.delay(5)
//Close browser
WebUI.closeBrowser()
