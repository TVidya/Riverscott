...
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Exportformats/searchinputfordatatemp'))
WebUI.delay(5)
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Exportformats/searchinputfordatatemp'),'demo1')
WebUI.sendKeys(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Exportformats/searchinputfordatatemp'),Keys.chord(Keys.ENTER))
WebUI.delay(5)
