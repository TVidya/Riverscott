...
WebUI.delay(5)
//Enter Message
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/sendMessage'), 'from katalon schedule Once test')
WebUI.delay(5)
...
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/particulardate-10'))
WebUI.delay(5)
//Save schedule
