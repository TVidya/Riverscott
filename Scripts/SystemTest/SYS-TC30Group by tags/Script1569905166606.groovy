...
WebUI.setText(findTestObject('Final Objects/MySelection/Tags/settexttag'),'systemtestset2')
WebUI.sendKeys(findTestObject('Final Objects/MySelection/Tags/settexttag'), Keys.chord(Keys.ENTER))
...
//Click on Result Control Menu
 ...
 WebUI.delay(5)
 //Click on Check box text tags group
 ...
 expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/SystemTest/SYS-TC30-EIC'), 10,
 ...
 tiexpected = WebUI.verifyElementPresent(findTestObject('Object Repository/Final Objects/Validation Objects/Expected/SystemTest/SYS-TC30- EFI'), 10,
	 FailureHandling.CONTINUE_ON_FAILURE)
