...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.FilterApplyBtn'()
 ...
 expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/SystemTest/SYS-TC36-EIC'), 10,
 ...
 //Save workspace
 CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SaveWorkspace'('SYS-TC51')
 //Close browser
 WebUI.closeBrowser()
