...
WebUI.delay(5)
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchfordatatempname'),'attachmentWithdocs')
...
WebUI.delay(5)
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/attachment/selAttachmentformat'),'TEXT')
