...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchTempname'), '1157801-96-dt15-3')
...
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Once'))
WebUI.delay(5)
//click on Time
...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/enterInputinsearch'), '13:00')
...
WebUI.delay(5)
//Click on Calendar
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/calendarIcon'))
WebUI.delay(5)
//Select particular Date in calendar
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/particulardate-17'))
WebUI.delay(5)
//Click on Speed
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/quality'))
WebUI.delay(5)
//Save schedule
