...
WebUI.delay(5)
//Enter Message
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/sendMessage'), 'from katalon schedule Monthly test-11513215-145')
WebUI.delay(5)
...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/SearchIP-DayForMonthlySchd'), '21')
