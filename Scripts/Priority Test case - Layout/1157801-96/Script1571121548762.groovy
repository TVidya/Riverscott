...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/searchattrinDataTemp'),"brand")
WebUI.delay(5)
...
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/searchattrinDataTemp'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/searchattrinDataTemp'),"8weeks Check")
WebUI.delay(5)
//Click on '8weeks Check' check box
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/ExportData/8weeks check'),10)
WebUI.delay(5)
//Reset entered search keyword
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/Resetsearchtext'))
WebUI.delay(5)
//Enter data template name
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/saveTempName'),"1157801-96-dt15-8")
WebUI.delay(5)
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail'),10)
WebUI.delay(5)
//Set Filename
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-filename'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-filename'),"1157801-96")
WebUI.delay(5)
//Set sendTo
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-sendTo'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-sendTo'),"shiva@slicerpl.com")
WebUI.delay(5)
//set Subject
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-subject'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-subject'),"1157801-96 -subject")
WebUI.delay(5)
//Set Message
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-message'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/send-viaemail-message'),"1157801-96-message")
WebUI.delay(10)
