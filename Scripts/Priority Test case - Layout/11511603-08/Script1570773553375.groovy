...
WebUI.delay(5)
//load template
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Template/loadtemp-imagemodes'))
WebUI.delay(5)
//Click on fill place holder
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/fillplaceholder'))
WebUI.delay(5)
