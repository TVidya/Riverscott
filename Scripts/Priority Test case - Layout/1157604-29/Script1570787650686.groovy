...
WebUI.delay(5)
//Click on input search attribute
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/attrsearchinTools'))
WebUI.delay(5)
//Search attribute in tools
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/attrsearchinTools'),'4weeks ros')
WebUI.sendKeys(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/attrsearchinTools'), Keys.chord(Keys.ENTER))
WebUI.delay(5)
//Enable 4 weeks ros attribute
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/chkattr-4weeksros'))
WebUI.delay(5)
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/SaveTemplate'),10)
WebUI.delay(10)
//Click on 'OK' button of Save template
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Savetemp-OKbtn'))
WebUI.delay(5)
