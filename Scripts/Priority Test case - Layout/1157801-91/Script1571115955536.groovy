...
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/Resetsearchtext'))
WebUI.delay(5)
//Click on export option as 'export data and images'
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/ExportData/Export-DataNdImgs'),10)
WebUI.delay(5)
//Click on best quality option
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/ExportData/Export-bestquality'),10)
WebUI.delay(5)
//Click on Done in best quality window
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/ExportData/btnDone-bestqualitywin'),10)
WebUI.delay(5)
//Enter data template name
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/saveTempName'),"1157801-91-dt15")
