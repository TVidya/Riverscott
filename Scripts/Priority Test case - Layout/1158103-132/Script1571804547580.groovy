...
//Click on share output link
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/ShareOutputLink'))
WebUI.delay(5)
//Click on User to share
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/ShareOutputLinkUsers/user19'))
WebUI.delay(5)
//Click on update button
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/ShareOutputLinkUsers/updatebtn'))
WebUI.delay(5)
...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/enterInputinsearch'), '21:00')
...
WebUI.delay(5)
//Click on Weekdays
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Friday'))
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Saturday'))
//WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Sunday'))
WebUI.delay(5)
//Save schedule
...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/saveschedulewith new name'),'1158103-132scheduleWeeklyset-1')
