...
WebUI.delay(5)
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchfordatatempname'),'attachmentwithoutspreadsheet')
...
WebUI.delay(5)
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/attachment/selAttachmentformat'),'OFFICE SPREADSHEET')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/ExportData/attachment/selAttachmentformat'),10)
WebUI.delay(5)
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/attachment/selAttachmentformat'),'OFFICE PRESENTATION')
WebUI.sendKeys(findTestObject('Object Repository/Final Objects/Layout/ExportData/attachment/selAttachmentformat'),Keys.chord(Keys.ENTER))
WebUI.delay(5)
