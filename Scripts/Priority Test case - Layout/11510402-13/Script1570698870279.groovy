...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/ListofWS/WS-1441001-15'),10)
WebUI.delay(5)
//Navigate to layout
...
WebUI.delay(5)
//Enter schedule name
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/saveschedulewith new name'),'11510402-13')
WebUI.delay(5)
...
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Exportformats/navToscheduleTab'))
WebUI.delay(5)
//Choose Schedule from current schedule list
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/currentschddropdown'))
WebUI.delay(5)
//Search for template name
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/currentschd-inputsearchbox'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/currentschd-inputsearchbox'), '11510402-13')
WebUI.sendKeys(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/currentschd-inputsearchbox'), Keys.chord(Keys.ENTER))
//Click on disable
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/currentschd-disable'),10)
WebUI.delay(10)
//Click on disable confirm 'OK' message
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/disableschedule button_OK'))
WebUI.delay(10)

/*
//Click on schedule update 'OK' button
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/schddisablesuccupdateOK'))
WebUI.delay(10)
//Click on Close schedule window
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/closeschdwindow'),10)
WebUI.delay(10)
