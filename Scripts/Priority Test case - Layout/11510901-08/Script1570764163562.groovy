...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchFormat'), 'JPG')
...
//Send To EmailId
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/sendTo'), 'shiva@slicerpl.com,ankeet@slicerpl.com')
WebUI.delay(5)
//Enter Message
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/sendMessage'), 'from katalon schedule Monthly test')
WebUI.delay(5)
...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/SearchIP-DayForMonthlySchd'), '12')
...
WebUI.click(findTestObject('Object Repository/Final Objects/MySelection/MainButns/kanvaslogo'))
WebUI.delay(5)
//Need to take screenshot and compare date
//Login with different User
//Click on username for dropdown menu
WebUI.click(findTestObject('Object Repository/Final Objects/MySelection/MainButns/USeRdropdwnMenu'))
WebUI.delay(5)
//Click on logout option
WebUI.click(findTestObject('Object Repository/Final Objects/MySelection/MainButns/a_Logout'))
WebUI.delay(5)
//login with different User
CustomKeywords.'com.test.demo.KanvasLoginCustomFunctions.KLoginSYSTST65user'()
//Click on kanvas logo
WebUI.click(findTestObject('Object Repository/Final Objects/MySelection/MainButns/kanvaslogo'))
WebUI.delay(5)
//Navigate to layout
...
//Search for WS
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchWSname'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchWSname'), 'SYS-TC51')
WebUI.sendKeys(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchWSname'), Keys.chord(Keys.ENTER))
//Click on Template dropdown
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/selectTemp'))
WebUI.delay(5)
...
//Enter time in search input
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/enterInputinsearch'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/enterInputinsearch'), '22:00')
WebUI.sendKeys(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/enterInputinsearch'), Keys.chord(Keys.ENTER))
WebUI.delay(5)
//Click on day
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/SelDayForMonth'))
