...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchWSname'), '1157802-66')
...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/searchTempname'), '1157801-96-dt15-2')
...
//Click on SendviaFTP' option
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/label-SendviaFTP'))
WebUI.delay(5)
//Click and set FTP url
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/FTP-url'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/FTP-url'),'ftp://180.179.52.197')
WebUI.delay(5)
//Click on FTP - Username
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/FTP-username'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/FTP-username'),'kanvasftp')
WebUI.delay(5)
//Click on FTP - Password
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/FTP-password'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/FTP-password'),'KanvasFiles')
WebUI.delay(5)
//Click on schedule Monthly
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Monthly'))
WebUI.delay(5)
//click on Time
...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/enterInputinsearch'), '11:00')
...
WebUI.delay(5)
//Click on day
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/SelDayForMonth'))
WebUI.delay(5)
//Select particular Day from the list
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/SearchIP-DayForMonthlySchd'))
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/SearchIP-DayForMonthlySchd'), '16')
WebUI.sendKeys(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/SearchIP-DayForMonthlySchd'), Keys.chord(Keys.ENTER))
WebUI.delay(5)
//Click on Speed
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/ExportData/SendviaFTP/speed'))
WebUI.delay(5)
//Save schedule
