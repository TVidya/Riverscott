...
WebUI.setText(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/enterInputinsearch'), '19:00')
...
WebUI.delay(5)
//Click on Runtill Date
//Click on Calendar Icon
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/RunstillCalendar'))
WebUI.delay(5)
//Click on displayed monthyear
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Runstill-selMonthYr'))
WebUI.delay(5)
//Select Month
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Runstill-choosemonth'))
WebUI.delay(5)
//Select Date
WebUI.click(findTestObject('Object Repository/Final Objects/Layout/Main Buttons/Schedule/Runstill-Date31'))
WebUI.delay(5)
//Save schedule
