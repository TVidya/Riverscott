...
WebUI.scrollToElement(findTestObject('Final Objects/MySelection/MainButns/li_Attributes_hierarchyBtn'), 5)

expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140406-10 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140406-10 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
