...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Attributes/li_COLLECTORS'), 
    10)
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Attributes/Group_category'), 
    10)
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Measures/div_calsoh'), 
    5)

CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_calsoh'), 
    findTestObject('Final Objects/MySelection/Measures/div_calsoh'), 10, '75.19')

CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_calsoh'), 
    findTestObject('Final Objects/MySelection/Measures/div_calsoh'), 10, '111.85')

WebUI.delay(5)

WebUI.click(findTestObject('Final Objects/MySelection/Measures/MIN_calsoh'))
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Stats Summary/Stats_4weeks ros'), 
    5)
...
WebUI.click(findTestObject('Final Objects/MySelection/MainButns/button_Apply_result control'))
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140409-15 EIC'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140409-15 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
