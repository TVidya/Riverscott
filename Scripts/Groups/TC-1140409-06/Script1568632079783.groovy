...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Budget'), 
    findTestObject('Final Objects/MySelection/Measures/div_budget'), 10, '68202.00')
...
WebUI.click(findTestObject('Final Objects/MySelection/MainButns/Result control Apply Button'))
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140409-06 EIC'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140409-06 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
