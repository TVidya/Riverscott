...
Expected = WebUI.verifyElementPresent(findTestObject('Object Repository/Final Objects/Validation Objects/Expected/TC-1140601-01 EIC'), 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Object Repository/Final Objects/Validation Objects/Expected/TC-1140601-01 EFI'), 
    10, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Final Objects/MySelection/Attributes/Reset_category'))
