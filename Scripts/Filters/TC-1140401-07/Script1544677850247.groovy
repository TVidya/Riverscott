...
//Click on hierarchy apply button
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.FilterApplyBtn'()

WebUI.delay(10)

//Verify tooltip info element present and click on it
...
//
expected = WebUI.verifyElementPresent(findTestObject('Object Repository/Final Objects/Validation Objects/Expected/TC-1140401-07 EIC'), 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Object Repository/Final Objects/Validation Objects/Expected/TC-1140401-07 EFI'), 
    10, FailureHandling.CONTINUE_ON_FAILURE)
