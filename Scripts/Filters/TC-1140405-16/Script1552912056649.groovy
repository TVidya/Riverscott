...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_calsoh'), 
    findTestObject('Final Objects/MySelection/Measures/MIN_calsoh'), 10, '61.50')
...
Expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140405-16 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140405-16 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
