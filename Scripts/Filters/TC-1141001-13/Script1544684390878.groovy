...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SaveWorkspace'('1141001-13')
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1141001-13 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1141001-13 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
