...
//CustomKeywords.'com.test.demo.MySelectionCustomFunctions.ScrollTo'(findTestObject('Object Repository/Final Objects/MySelection/Hierarchys/div_GD'), 10)
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SaveWorkspace'('1141001-07')
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1141001-07 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1141001-07 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
