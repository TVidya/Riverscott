...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140601-03 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140601-03 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Final Objects/MySelection/Attributes/Reset_brand'))

CustomKeywords.'com.test.demo.MySelectionCustomFunctions.HierarchyBtn'()

CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Hierarchys/Reset_Climate'), 
    10)
