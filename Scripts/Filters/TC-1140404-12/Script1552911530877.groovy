...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_calsoh'), 
    findTestObject('Final Objects/MySelection/Measures/div_calsoh'), 10, '62.97')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_calsoh'), 
    findTestObject('Final Objects/MySelection/Measures/div_calsoh'), 10, '99.63')
...
Expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140404-12 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140404-12 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
