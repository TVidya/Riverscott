...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '-453.56')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '8053.96')

WebUI.delay(5)

WebUI.click(findTestObject('Final Objects/MySelection/Measures/MIN_Soh2'))
...
Expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140405-23 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140405-23 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
