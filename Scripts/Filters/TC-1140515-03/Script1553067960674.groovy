...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SaveWorkspace'('1140515-03')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.ScrollTo'(findTestObject('Final Objects/MySelection/Workspaces/div_1140515-03'), 
    10)
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140515-03 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140515-03 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
