...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Budget'), 
    findTestObject('Final Objects/MySelection/Measures/div_budget'), 10, '81401.00')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_Budget'), 
    findTestObject('Final Objects/MySelection/Measures/div_budget'), 10, '302203.00')

WebUI.delay(5)

WebUI.click(findTestObject('Final Objects/MySelection/Measures/MIN_Budget'), FailureHandling.STOP_ON_FAILURE)
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140401-03 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140401-03 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
