...
//WebUI.click(findTestObject('Final Objects/MySelection/MainButns/span_Welcome kat54cid005.com_c'))
//WebUI.click(findTestObject('Final Objects/MySelection/MainButns/a_Save Workspace'))
//WebUI.sendKeys(findTestObject('Final Objects/MySelection/MainButns/input_Name your workspace_wrkS'), '1140515-02')
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SaveWorkspace'('1140515-02')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.ScrollTo'(findTestObject('Final Objects/MySelection/Workspaces/div_1140515-02'), 
    10)
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140515-02 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140515-02 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
