...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Budget'), 
    findTestObject('Final Objects/MySelection/Measures/div_budget'), 10, '-214996.00')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_Budget'), 
    findTestObject('Final Objects/MySelection/Measures/div_budget'), 10, '430007.00')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SaveWorkspace'('1140515-04')

WebUI.delay(5)

CustomKeywords.'com.test.demo.MySelectionCustomFunctions.LoadWorkspace'(findTestObject('Final Objects/MySelection/Workspaces/div_1140515-04'), 
    10)
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140515-04 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140515-04 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
