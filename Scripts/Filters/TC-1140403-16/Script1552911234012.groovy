...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '-85.40')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '918.95')
...
Expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140402-16 EIC'), 10, 
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140402-16 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
