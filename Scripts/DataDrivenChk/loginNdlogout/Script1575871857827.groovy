...
WebUI.setText(findTestObject('Object Repository/Final objects/Login credentials/input_user'), User)

WebUI.setText(findTestObject('Object Repository/Final objects/Login credentials/input_encPass'), Pwd)
...
//lets proceed check
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Final objects/Login credentials/button_Lets Proceed'), 
