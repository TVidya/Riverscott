...
WebUI.scrollToElement(findTestObject('Final Objects/MySelection/MainButns/Showmsrsbtn'), 10)
...
CustomKeywords.'com.BB.genralFunctions.doStats'(showDataAttrName, nSep)
//Save and show data selection
CustomKeywords.'com.BB.genralFunctions.saveShowData'()
WebUI.delay(5)