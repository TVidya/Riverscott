...
//Group sort
CustomKeywords.'standardFunc.AllstandardFunc.DogroupSort'(grpsortAttrName,grpattrStatus,aggrVal,nSep,vSep)
//CustomKeywords.'com.BB.genralFunctions.grpSortAggr'(grpsortAttrName,aggrVal)
WebUI.delay(10)
/*
