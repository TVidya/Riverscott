...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Budget'), 
    findTestObject('Final Objects/MySelection/Measures/div_budget'), 10, '10000.00')
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_Budget'), 
    findTestObject('Final Objects/MySelection/Measures/div_budget'), 10, '242808.00')
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140101-17 EIC'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140101-17 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
