...
WebUI.click(findTestObject('Final Objects/MySelection/Tags/div_Basic'))

WebUI.delay(5)

WebUI.click(findTestObject('Final Objects/MySelection/Tags/img_Basic_img-icn-tag'))
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Hierarchys/li_MIDDLE EAST'), 
    10)
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Hierarchys/li_SOUTH EAST ASIA()'), 
    10)
...
CustomKeywords.'com.test.demo.MySelectionCustomFunctions.clickUsingJS'(findTestObject('Final Objects/MySelection/Measures/div_soh2'), 
    5)

CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MIN_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '92.70')

CustomKeywords.'com.test.demo.MySelectionCustomFunctions.SetMsrVal'(findTestObject('Final Objects/MySelection/Measures/MAX_Soh2'), 
    findTestObject('Final Objects/MySelection/Measures/div_soh2'), 10, '1624.32')

WebUI.delay(5)

WebUI.click(findTestObject('Final Objects/MySelection/Measures/div_soh2'))
...
expected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140102-63 EIC'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
...
tiexpected = WebUI.verifyElementPresent(findTestObject('Final Objects/Validation Objects/Expected/TC-1140102-63 EFI'), 10, 
    FailureHandling.CONTINUE_ON_FAILURE)
