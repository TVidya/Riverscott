...
WebUI.setText(findTestObject('Final Objects/MySelection/Search/input_Search In Result_search-box'), 'BMV01')
...
def fd() {
    ...
    Process process = runtime.exec('D:\\cameraupload-Overwrite.exe')
...
def ld() {
    ...
    Process process = runtime.exec('D:\\cameraupload-skip.exe')
...
def ed() {
    ...
    Process process = runtime.exec('D:\\cameraupload-initial.exe')
...
def sd() {
    ...
    Process process = runtime.exec('D:\\cameraupload-Append.exe')
